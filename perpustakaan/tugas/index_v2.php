...
<head>
    ...
    <style>
        ...
        .perpus { background: #e3f2fd; border-left: 4px solid #1976d2; padding: 12px; margin: 10px 0; }
    </style>
</head>
<body>
    <div class="card">
        ...
        <div class="info">
            ...
            <p><strong>Dibuat oleh:</strong> <?php echo "Muhammad Shofy Fuady"; ?></p>
        ...
        $alamat_perpus  = "Jl. Pendidikan No. 1, Jakarta Pusat, DKI Jakarta";
        $telepon_perpus = "(021) 1234-5678";
        $jam_buka       = "08:00";
        $jam_tutup      = "16:00";
    ...
    <!-- Card Informasi Perpustakaan -->
    <div class="card">
        <h1>📚 Informasi Perpustakaan</h1>

        <div class="perpus">
            <h3>🏠 Detail Perpustakaan</h3>
            <p><strong>Nama:</strong> <?php echo $nama_perpus; ?></p>
        ...
        <div class="perpus">
            ...
            <p><strong>Jam Buka:</strong> <?php echo $jam_buka; ?> WIB</p>
            <p><strong>Jam Tutup:</strong> <?php echo $jam_tutup; ?> WIB</p>
            <p><strong>Hari Operasional:</strong> Senin – Jumat</p>
